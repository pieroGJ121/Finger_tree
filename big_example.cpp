...
int main() {
  ...
  while (window.isOpen()) {
    ...
    leyendaPLOMO.setPosition(leyendaX - leyendaPLOMO.getLocalBounds().width,
                             leyendaY);
    ...
    leyendaROJO.setPosition(leyendaX - leyendaROJO.getLocalBounds().width,
                            leyendaY);
    ...
    leyendaAZUL.setPosition(leyendaX - leyendaAZUL.getLocalBounds().width,
                            leyendaY);
    ...
    leyendaAMARILLO.setPosition(
        leyendaX - leyendaAMARILLO.getLocalBounds().width, leyendaY);
    ...
    leyendaNEGRO.setPosition(leyendaX - leyendaNEGRO.getLocalBounds().width,
                             leyendaY);
    ...
    leyendaVERDE.setPosition(leyendaX - leyendaVERDE.getLocalBounds().width,
                             leyendaY);
